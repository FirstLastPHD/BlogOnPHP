...
abstract class AbstractDataBase {
	...
	private $prefix;
	//private $lang;
	protected function __construct($db_host, $db_user, $db_password, $db_name, $sq, $prefix/*$lang*/) {
		$this->mysqli = @new mysqli($db_host, $db_user, $db_password, $db_name);
		if ($this->mysqli->connect_errno) exit("Error Database Connection !!!");
		$this->sq = $sq;
		$this->prefix = $prefix;
		//$this->lang = $lang
		$this->mysqli->query("SET lc_time_names = 'en_EN'");
		//$this->mysqli->query("SET lc_time_names = $lang");
